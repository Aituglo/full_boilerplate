...
import NavImg from '@app/assets/img/nav.png';
      ...
      <SideNav
        trigger={
          <div className="avatar-button">
            <button
              type="button"
              className="vertical button-collapse btn-floating btn-large blue darken-1"
            >
      ...
      >
        <li>
          <div className="userView">
            ...
            <button type="button" className="circle blue darken-1">
